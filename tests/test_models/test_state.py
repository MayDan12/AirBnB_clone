...
class TestState_instantiation(unittest.TestCase):
    """This Unittests for testing instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """The Unittests for testing save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """The Unittests for testing to_dict method of the State class."""
