...
class TestCity_instantiation(unittest.TestCase):
    """sthi Unittests for testing instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """This Unittests for testing save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """This Unittests for testing to_dict method of the City class."""
