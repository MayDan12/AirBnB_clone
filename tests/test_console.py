...
class TestHBNBCommand_help(unittest.TestCase):
    """This Unittests for testing help messages of the HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """This Unittests for testing exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Thsi Unittests for testing create from the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """This Unittests for testing show from the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Thisa Unittests for testing destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """This Unittests for testing all of the HBNB command interpreter."""
